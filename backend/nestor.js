...
global.http_port = parseInt(process.env.hasOwnProperty('PORT') ? process.env.PORT : (global.env == "dev" ? 30008 : 3008));
global.ws_port = parseInt(process.env.hasOwnProperty('PORT_SCK') ? process.env.PORT_SCK : (global.env == "dev" ? 30009 : 3009));
